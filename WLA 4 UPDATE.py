...
st.markdown(
    "<h2 style='text-align: center; color: #1E3A8A;'>Sistem Pendukung Keputusan Analisis Beban Kerja & Optimasi Tenaga Kerja</h2>",
    unsafe_allow_html=True,
)
st.caption(
    "<p style='text-align: center;'>Metode: Time Study & Workload Analysis (WLA) - Single Line Production</p>",
    unsafe_allow_html=True,
)

# ==========================================
# 2. SIDEBAR - PARAMETER OPERASIONAL & BIAYA
# ==========================================
...
# FITUR 2: PARAMETER BIAYA FINANSIAL
...
# ==========================================
# 4. KALKULASI TIME STUDY, WLA & FITUR 4 (FATIGUE RISK)
# ==========================================
...
# FITUR 4: LOGIKA INDIKATOR RISIKO FATIGUE / ERGONOMI
...
with tab2:
  ...
  with col_pie2:
    # FITUR 4 DISPLAY: TABEL ERGONOMIC FATIGUE RISK
  ...
  if list_over and list_under:
    ...
    if sisa_kapasitas_menit > 0:
      ...
      if st.button("Terapkan Redistribusi"):
        ...
        # Update % WLA, Kategori, & Fatigue Risk
...
# ------------------------------------------
# PAGE 5: REKOMENDASI DSS, BIAYA, & EXPORT REPORT
# ------------------------------------------
with tab5:
  ...
  if sisa_over == 0 and sisa_under == 0:
    ...
    # KALKULATOR LEMBUR & FITUR 2: BIAYA FINANSIAL
    st.markdown(
  ...
  st.download_button(
      label="📥 Download Laporan Lini (Excel .xlsx)",
